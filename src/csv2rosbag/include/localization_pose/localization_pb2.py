...
_UNCERTAINTY.fields_by_name['position_std_dev'].message_type = geometry__pb2._POINT3D
_UNCERTAINTY.fields_by_name['orientation_std_dev'].message_type = geometry__pb2._POINT3D
_UNCERTAINTY.fields_by_name['linear_velocity_std_dev'].message_type = geometry__pb2._POINT3D
_UNCERTAINTY.fields_by_name['linear_acceleration_std_dev'].message_type = geometry__pb2._POINT3D
_UNCERTAINTY.fields_by_name['angular_velocity_std_dev'].message_type = geometry__pb2._POINT3D
_LOCALIZATIONESTIMATE.fields_by_name['header'].message_type = header__pb2._HEADER
_LOCALIZATIONESTIMATE.fields_by_name['pose'].message_type = pose__pb2._POSE
_LOCALIZATIONESTIMATE.fields_by_name['uncertainty'].message_type = _UNCERTAINTY
_LOCALIZATIONESTIMATE.fields_by_name['trajectory_point'].message_type = pnc__point__pb2._TRAJECTORYPOINT
...
_LOCALIZATIONSTATUS.fields_by_name['header'].message_type = header__pb2._HEADER
