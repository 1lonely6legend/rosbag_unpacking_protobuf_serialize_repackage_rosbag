...
_POSE.fields_by_name['position'].message_type = geometry__pb2._POINTENU
_POSE.fields_by_name['orientation'].message_type = geometry__pb2._QUATERNION
_POSE.fields_by_name['linear_velocity'].message_type = geometry__pb2._POINT3D
_POSE.fields_by_name['linear_acceleration'].message_type = geometry__pb2._POINT3D
_POSE.fields_by_name['angular_velocity'].message_type = geometry__pb2._POINT3D
_POSE.fields_by_name['linear_acceleration_vrf'].message_type = geometry__pb2._POINT3D
_POSE.fields_by_name['angular_velocity_vrf'].message_type = geometry__pb2._POINT3D
_POSE.fields_by_name['euler_angles'].message_type = geometry__pb2._POINT3D
