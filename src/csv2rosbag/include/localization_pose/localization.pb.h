...
enum MeasureState {
  ...
  CRITICAL_ERROR = 3,
  FATAL_ERROR = 4,
  MeasureState_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  MeasureState_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
inline bool LocalizationEstimate::has_msf_status() const {
  return this != internal_default_instance() && msf_status_ != NULL;
}
...
inline bool LocalizationEstimate::has_sensor_status() const {
  return this != internal_default_instance() && sensor_status_ != NULL;
}
